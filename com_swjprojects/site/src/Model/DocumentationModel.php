...
class DocumentationModel extends ListModel
{
	 ...
	 * @since  1.4.0
	 */
	protected $_context = 'com_swjprojects.documentation';
	 ...
	 *
	 * @return  DatabaseQuery  Database query to load documents list.
	 *
	 * @since  1.4.0
	 */
	...
	public function getItems()
	{
		if ($items = parent::getItems())
		{
			foreach ($items as &$item)
			{
				...
				$item->link  = Route::_(RouteHelper::getDocumentRoute($item->slug, $item->pslug, $item->cslug));
				...
				$item->project->documentation = Route::_(RouteHelper::getDocumentationRoute($item->pslug, $item->cslug));
	 ...
	 * @throws  \Exception
	 *
	 * @return  object|bool|\Exception  Project object on success, false or exception on failure.
	 *
	 * @since  1.4.0
	 */
