		...
		if (!isset($this->_extensionXML[$hash]))
		{
			try
			{
				...
				foreach ($items as $item)
				{
					...
					$item->download = Route::_(RouteHelper::getDownloadRoute($item->id, null,
...
//						$changelog_url = Uri::root().
						$update->addChild('changelogurl',$site_root.Route::_(RouteHelper::getJChangelogRoute(null, $item->element)));
					}
