...
namespace Joomla\Component\SWJProjects\Site\View\Documentation;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$doc->setDescription($project->metadata->get('documentation_description'));
		}
		...
		{
			$doc->setMetadata('keywords', $project->metadata->get('documentation_keywords'));
		}
		...
		{
			$doc->setMetadata('image', Uri::root() . $project->metadata->get('documentation_image'));
		}
		...
		{
			$doc->setMetadata('robots', $project->metadata->get('documentation_robots'));
		}
