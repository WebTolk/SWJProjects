...
class SWJProjectsViewVersions extends HtmlView
{
	...
	protected function _prepareDocument()
	{
		...
		{
			$this->document->setDescription(StringHelper::truncate($project->introtext, 150, false, false));
		}
		...
		{
			$this->document->setMetadata('image', Uri::root() . $project->metadata->get('versions_image'));
		}
